# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/bitcomputing/go-openai.svg)](https://pkg.go.dev/github.com/bitcomputing/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/bitcomputing/go-openai)](https://goreportcard.com/report/github.com/bitcomputing/go-openai)
[![codecov](https://codecov.io/gh/bitcomputing/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/bitcomputing/go-openai)
...
```
go get github.com/bitcomputing/go-openai
```
...
See also: https://pkg.go.dev/github.com/bitcomputing/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/bitcomputing/go-openai"
	"github.com/bitcomputing/go-openai/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/bitcomputing/go-openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/bitcomputing/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/bitcomputing/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/bitcomputing/go-openai/graphs/contributors) and sponsors of this project:
