...
type ChatMessageFile struct {
	FileData string `json:"file_data,omitempty"` // The base64 encoded file data, used when passing the file to the model as a string.
	FileId   string `json:"file_id,omitempty"`   //The ID of an uploaded file to use as input.
	FileName string `json:"file_name,omitempty"` //The name of the file, used when passing the file to the model as a string.
}
